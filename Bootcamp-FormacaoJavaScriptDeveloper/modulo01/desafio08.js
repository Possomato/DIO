...
atualizar com function

*/

function calcularTaxa(preco, metodo){
    if (metodo == 1){
        novoPreco = preco - (preco * 0.10)
        return(`o valor a ser pago será R$${novoPreco}`)
    } else if (metodo == 2){
        novoPreco = preco - (preco * 0.15)
        return(`o valor a ser pago será R$${novoPreco}`)
    } else if (metodo == 3){
        return(`o valor a ser pago será R$${preco}`)
    } else if (metodo == 4){
        novoPreco = preco + (preco * 0.10)
        return(`o valor a ser pago será R$${novoPreco}`)
    }
...
console.log(calcularTaxa(900, 2))
